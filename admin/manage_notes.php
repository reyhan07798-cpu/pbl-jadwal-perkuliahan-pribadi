...
// Ambil data catatan beserta username pembuat
                ...
                <tbody>
                    <?php if ($notes->num_rows > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="manage_notes.php?delete_id=<?php echo $note['id']; ?>" class="btn btn-danger btn-sm" title="Hapus" onclick="return confirm('Yakin ingin menghapus catatan ini?')"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
